...
def init_candle_list(ticker, count) :
    ...
    url = f'https://fchart.stock.naver.com/sise.nhn?symbol={ticker}&timeframe=month&count={count}&requestType=0'
    req = Request(url)
